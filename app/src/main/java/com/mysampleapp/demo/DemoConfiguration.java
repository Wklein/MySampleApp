...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("Waffle_Test", R.mipmap.icon_check, R.string.feature_waffle_title, R.string.feature_waffle_title, R.string.feature_waffle_title, R.string.feature_waffle_title, R.string.feature_waffle_title, new DemoItem(R.string.feature_waffle_title, R.string.feature_waffle_title, R.string.feature_waffle_title, WaffleShowFragment.class));
    }
