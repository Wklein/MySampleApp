...
/**
 * Created by Mushroomhermit on 8/6/2016.
 */
public class FileFetcher implements Iterator<S3ContentSummary>, Iterable<S3ContentSummary>, Runnable {
        /** Logging tag for this class. */
        private static final String LOG_TAG = FileFetcher.class.getSimpleName();
         ...
         */
        public FileFetcher          (final AmazonS3 s3Client, final String bucketName, final String s3ContentPrefix,
